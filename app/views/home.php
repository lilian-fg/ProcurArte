...
<div class="container">
    ...
    <div class="card mb-3 mt-3">
        ...
        <p>Este projeto contém um exemplo de um CRUD de usuários: <a href="<?=route("artista")?>"><?=route("artista")?></a> </p>
        </div>
    </div>
    ...
    <div class="card mb-3 mt-3">
        ...
        <table class="table">
            ...
            <tr>
                ...
                <td>
                    Entrega para você o endereço para algum controle: <?=route('artista')?>
